/* Anthony Mai : amai005@ucr.edu
* Lab Section: 002
* Assignment: Custom Project
* UCR EE 120B Winter 2016
*
*hex conditions:
*	0x01...0x04: corresponds to increment score (+1..+4)
*	0x05...0x08: corresonds to decrement lifepts (-1...-4)
*	0x09: win, 0x0A lose
*	0x2A, 0x23, 0x30...0x39, 0x41...0x44: corresponds to keypad_input ('*','#','0'....'9','A'...'D')
*/
...
*			-How many dogs jumped over the balls; thus incrementing accordingly
*			-How many dogs hit a ball; thus decremementing accordingly
*/
...
*				 4th Dog: Left(), Right()
*	   C = Reset all dogs to default column
*/
	...
	switch(state){
		...
		case Led_Game:
			...
			//if(arduino_receive == 0x02){
				...
				//the max lifepoints that can be decremented is 4 (because there is a max of 4 dogs)
				arduino_receive -= 4; 
